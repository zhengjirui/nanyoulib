...
@ProviderTag(messageContent = WaitMessage.class, showReadState = true)
public class TestMessageProvider extends IContainerItemProvider.MessageProvider<WaitMessage>{
...
//        holder.ny_view_line = view.findViewById(R.id.ny_view_line);
        view.setTag(holder);
        return view;
    }

    @Override
    public Spannable getContentSummary(WaitMessage data) {
        if (data == null)
            return null;
    ...
    @Override
    public void onItemClick(View view, int position, WaitMessage content, UIMessage message) {

    }

    @Override
    public void onItemLongClick(final View view, int position, final WaitMessage content, final UIMessage message) {
        ...
        OptionsPopupDialog.newInstance(view.getContext(), items).setOptionsPopupDialogListener(new OptionsPopupDialog.OnOptionsItemClickedListener() {
            ...
            public void onOptionsItemClicked(int which) {
                if (which == 0) {
                    ...
                    clipboard.setText(((WaitMessage) content).getContent());
                } else if (which == 1) {
    ...
    @Override
    public void bindView(final View v, int position, final WaitMessage content, final UIMessage data) {
