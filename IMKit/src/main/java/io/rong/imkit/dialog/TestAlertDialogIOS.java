...
public class TestAlertDialogIOS {
    ...
    public TestAlertDialogIOS setPositiveButton(String text, final View.OnClickListener listener) {
        if ("".equals(text)) {
            btn_pos.setText("");
        } else {
...
//				dialog.dismiss();
    ...
    public TestAlertDialogIOS setNegativeButton(String text, final View.OnClickListener listener) {
        if ("".equals(text)) {
            btn_neg.setText("");
        } else {
