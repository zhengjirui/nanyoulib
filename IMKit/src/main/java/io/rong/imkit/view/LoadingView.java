...
public class LoadingView extends LinearLayout {
    ...
    private TextView mShapeLoadingView;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        LayoutInflater.from(context).inflate(R.layout.ny_wait_view, this, true);
        mShapeLoadingView = (TextView) findViewById(R.id.shapeLoadingView);
    ...
    private Runnable mFreeFallRunnable = new Runnable() {
        @Override
        public void run() {
//            ViewHelper.setRotation(mShapeLoadingView, 0);
    ...
    public void setJumpText(CharSequence jumpText){
        if(mShapeLoadingView != null && jumpText != null){
            mShapeLoadingView.setText(jumpText);
        }
    }
